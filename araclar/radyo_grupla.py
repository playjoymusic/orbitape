...
AILELER = OrderedDict([
    ...
    # AFROBEATS GERI ACILDI (ayni gun): raf dolunca iceri girenlerin
    # cogunun hip hop degil AFRO oldugu goruldu. Hasat bu rafa
...
# ── YAPAY ZEKA URETIMI YAYINLAR (10 Eylul gece) ────────────────────
# Kullanicinin karari: "ai istemiyorum, cikar; baska varsa da cikar,
# ai yasak."
# Gerekce uygulamanin kendi sozuyle ayni: ORBITAPE calan seyin
# KIMLIGINI gosteriyor -- kim yapti, hangi lisansla. Uretimi makineye
# birakan bir yayinda o kunye yok; ekranda yazacak bir sanatci da yok.
# Etiketler dizinde istasyonun KENDI beyani: "ai radio", "ai music",
# "ai generated" yazan bir yayin bunu saklamiyor zaten.
# \bai\b tek basina da sayiliyor -- "ai,ambient,focus" diye baslayan
# etiket kuyrugunda o harfler baska bir kelimenin parcasi degil.
YAPAY = re.compile(r"\bai\b|\bai[ -]?radio\b|\bai[ -]?music\b|"
                   r"ai[- ]generated|generated by ai|artificial intelligence|"
                   r"yapay zek", re.I)
...
def temizle(kayitlar):
    ...
    sayac = {"cift": 0, "ulke": 0, "ibadet": 0, "konusma": 0, "yapay": 0}
    gorulen = set()
    kalan = []
    for o in kayitlar:
