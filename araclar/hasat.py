...
PLAN = [
    ...
    # Yeni zenginlik kümeleri: mevcut doğa/şehir/records raflarını
    # daha belirgin kaynaklarla besler; lisans kapısı aşağıda aynıdır.
    ('subject:(bioacoustic)',               700, 'AMBIANCE'),
    ('subject:(biophony)',                 400, 'AMBIANCE'),
    ('collection:(hamiltonbioacoustics)',  700, 'AMBIANCE'),
    ('collection:(aporee)',                700, 'AMBIANCE'),
    ('subject:(sound map)',                500, 'AMBIANCE'),
    ('subject:(urban soundscape)',         500, 'AMBIANCE'),
    ('collection:(great78)',               600, 'RECORDS'),
    ('subject:(78 rpm)',                   600, 'RECORDS'),
    ('subject:(folk music)',               600, 'RECORDS'),
    ('subject:(traditional music)',        600, 'RECORDS'),
    ('subject:(scientific recording)',     400, 'AMBIANCE'),
    ('subject:(experimental electronic)',  500, 'AMBIANCE'),
