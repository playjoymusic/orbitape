...
(function(){
  ...
  const KURALLAR = [
    ...
    ".st-baslik{font-size:11px;letter-spacing:.3em;opacity:.55}",
    ".st-bolum{padding:12px 0 6px}",
    ".st-bolum + .st-bolum{border-top:1px solid color-mix(in srgb,var(--st-yazi) 14%,transparent)}",
    ".st-ad{font-size:10px;letter-spacing:.3em;opacity:.5;margin-bottom:8px}",
    ...
    ".st-deger{font-size:22px;letter-spacing:.06em;min-width:96px;text-align:center}",
    ".st-tus{appearance:none;-webkit-appearance:none;border:0;background:transparent;color:inherit;padding:6px 4px;font:inherit;font-size:12px;letter-spacing:.14em;cursor:pointer;opacity:.62;-webkit-tap-highlight-color:transparent;transition:opacity .18s,color .18s}",
    ".st-tus:hover,.st-tus:focus-visible{opacity:1}",
    ".st-tus.eksi,.st-tus.arti{font-size:20px;padding:0 8px;opacity:.8}",
    ".st-tus.kapat{font-size:14px;opacity:.5}",
    ...
    ".st-saat,.st-secim{appearance:none;-webkit-appearance:none;border:0;background:transparent;color:var(--st-vurgu);font:inherit;font-size:20px;letter-spacing:.04em;padding:0;cursor:pointer}",
    ".st-saat::-webkit-calendar-picker-indicator{display:none}",
    ".st-secim{font-size:12px;letter-spacing:.14em;flex:1;min-width:0;text-overflow:ellipsis;padding-right:14px;background-image:linear-gradient(45deg,transparent 50%,currentColor 50%),linear-gradient(135deg,currentColor 50%,transparent 50%);background-position:calc(100% - 8px) 55%,calc(100% - 4px) 55%;background-size:4px 4px;background-repeat:no-repeat}",
    ".st-durum{font-size:11px;opacity:.6;line-height:1.5;letter-spacing:.06em}",
    ".st-not{font-size:10px;opacity:.45;line-height:1.6;margin-top:10px;letter-spacing:.04em}",
    ".st-calan{display:flex;flex-direction:column;gap:10px;padding:10px 0 14px;align-items:center}",
    ".st-calan-yazi{font-size:16px;letter-spacing:.34em}",
    ".st-tus.ertele{font-size:13px;opacity:.8}",
    ".st-tus.dur{width:100%;padding:12px 18px;font-size:13px}"
  ];
